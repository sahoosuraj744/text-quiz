...
import { Cpu, CheckCircle, AlertCircle, XCircle, Search,Filter,X,Clock,FileText ,Calendar,Trash2,Plus} from "lucide-react";
const List = () => {
  ...
  useEffect(() => {
    const currentToastTimer = toastTimerRef.current;
      ...
      <div className={listPageStyles.container}>
        <div className={listPageStyles.headerWrapper}>
          ...
          <div className={listPageStyles.searchContainer}>
            <div
              className={`${listPageStyles.animatedBorderBase} ${animateBorder ? listPageStyles.animateBorderActive : ""}`}
            />
            <div className={listPageStyles.inputWrapper}>
              <div className="relative">
                ...
                value={searchTerm} onChange={(e)=>setSearchTerm(e.target.value)}
                  className={`${listPageStyles.inputBase } ${selectedLevel!=="All" ?
            ...
            <div className={listPageStyles.emptyContent}>
              <div className={listPageStyles.emptyIconBox}>
               ...
               <p className={listPageStyles.emptyText}>
                ...
                "Try adjusting your search or filter what you are looking for":
