        ...
        <div className={dashboardStyles.grid}>
          <div className={dashboardStyles.mainColumn}>
            <div className={dashboardStyles.card}>
              <h2 className={dashboardStyles.cartTitle}>Create new Quiz</h2>
              <div className={dashboardStyles.formFields}>
                    ...
                    {levels.map((e) => (
                      <button
                        ...
                        className={`${dashboardStyles.levelButtonBase} ${
                          level === e.value
                            ? `${e.bg} border-2 ${e.color.replace("text", "border")}`
                            : "border-gray-200 hover:border-gray-300"
                        }`}
                        type="button"
                      >
                        <span
                          className={`${dashboardStyles.levelButtonTextBase} ${level === e.value ? e.color : "text-gray-600"}`}
                        >
                          {e.value}
                        </span>
                      </button>
                ...
                <div>
                  ...
                  <div className={dashboardStyles.timeHint}>
                    ...
                    <span>
                      Time allocated per participant to complete quiz{" "}
                    </span>
                  </div>
                  {validationErrors.timeLimit && (
                    <p className={dashboardStyles.errorMessage}>
              ...
              <div className={dashboardStyles.previewHeader}>
                <div>
                  ...
                  <p className={dashboardStyles.previewSubtitle}>
                    Review All the questions before creating the quiz
                  </p>
                </div>
