import {resultPageStyles,resultPageAnimations,getColorClass,colorClasses,getBadgeClasses,getBadgeText} from '../assets/style'
...
const Badge=({percent})=>{
    ...
    return <span classes={classes}>{text}</span>
}
            ...
            <div className={resultPageStyles.stripCardContent}>
                <div className={resultPageStyles.stripCardTopRow}>
                    <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className={resultPageStyles.stripCardContainer}>
                ...
                <section key={track} className={resultPageStyles.trackSection}>
                   ...
                   <div className={resultPageStyles.cardsGrid}>
                    {items.map((r)=>(
                        ...
                        open={!!openStates[makeKey(r)]} onToggle={()=>toggle(makeKey)}/>
                    ))}
                   </div>
                </section>
            ))}
         </div>
         <style>{resultPageAnimations}</style>
    </div>
  )
}
